...
var range = function range(cur, end) {
  var result = [];
...
var initSheet = JSON.parse(localStorage.getItem("")) || sheetDefault;

var Sheet = function Sheet(props) {
  var _useState = (0, _react.useState)(props.worker),
      _useState2 = _slicedToArray(_useState, 2),
      worker = _useState2[0],
      setWorker = _useState2[1];

  var _useState3 = (0, _react.useState)(initSheet),
      _useState4 = _slicedToArray(_useState3, 2),
      sheet = _useState4[0],
      setSheet = _useState4[1];

  var _useState5 = (0, _react.useState)(initSheet),
  ...
  var calc = function calc(sheet) {
    setSheet(sheet);
    var timeout = setTimeout(function () {
      worker.terminate();
      setWorker(new Worker("/worker.ab30da2c.js"));
    }, 99);
  ...
  return _react.default.createElement("table", null, _react.default.createElement("tbody", null, _react.default.createElement("tr", null, _react.default.createElement("th", null, _react.default.createElement("button", {
    onClick: reset
    ...
    return _react.default.createElement("tr", {
      key: i
    }, _react.default.createElement("th", null, row), cols.map(function (col, j) {
      return _react.default.createElement("td", {
        key: j,
        className: sheet[col + row] && sheet[col + row] === "=" ? "formula" : ""
        ...
        onChange: function onChange(_ref2) {
          ...
          calc(_objectSpread({}, sheet, _defineProperty({}, id, value)));
        },
        onKeyDown: function onKeyDown(_ref3) {
          ...
          switch (which) {
            ...
            case 40:
            case 13:
              var direction = which === 38 ? row - 1 : row + 1;
              var cell = document.querySelector("#".concat(col + direction));
        ...
        className: errs[col + row] ? "err" : vals[col + row] ? "text" : ""
...
window.init = function () {
  ...
  worker.onmessage = function () {
    _reactDom.default.render(_react.default.createElement(Sheet, {
      worker: worker
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./worker.js":[["worker.ab30da2c.js","worker.js"],"worker.ab30da2c.map","worker.js"]}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
